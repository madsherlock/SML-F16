...
The graphs seen in \ref{fig:knnFit_80}, \ref{fig:knnFit_90}, \ref{fig:knnFit_99} shows some weird output around k = 3, which unknown at the moment, but could be due to an inaccurate data representation.  The perfomance of the system with normalization were not possible to compute due to timing constraint. It is at moment unclear whether the normalization would have any effect at all, the data consist of pixel values extracted from the hand writtens digits, those values are already constrained to a certain range, so it seems unclear at moment how an normalization would benefit.   